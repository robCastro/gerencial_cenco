...
#PDFS
	url(r'^pdf_desempenio_estudiantil/(?P<grupo>\d{1,2})/(?P<desempenio>\d{1})/(?P<cantidad>\d{1,2})$',views.RepDesempenioEstudiantil.as_view(), name='pdf_desempenio_estudiantil'),
